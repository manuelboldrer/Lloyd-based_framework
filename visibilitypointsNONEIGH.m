function [Xvis1,Yvis1]= visibilitypointsNONEIGH(x,y,obs,obsD,VobsD,rr,xlim,ylim,Rmax,epsi,q,dA,Rcoh,th,b,Ad, Rmaxt0)
...
for r=0:0.05:Rmaxt0(q)
    for j = 1:length(th)
        ...
        for jj = 1:length(x)
            ...
            if noCollision([x(q),y(q)]',[xcirc(j),ycirc(j)]',obs)==1 && all(vec) && coh 
