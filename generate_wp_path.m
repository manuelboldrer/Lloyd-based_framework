function [wp_smart, index_min, wp_path, Tend, flag] = generate_wp_path(waypoints, x, y, index_prev, kk, obs, Rmaxt0)
flag         = 0;
L_calculus   = Rmaxt0;%1 % the largest curvilinear distance from the wp, i.e., max preview lenght
L_min        = Rmaxt0;%1 % minimum preview lenght
max_distance = Rmaxt0; % if the closest wp is further than this, return it as wp_smart
